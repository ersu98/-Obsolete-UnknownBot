...
bot.on("ready", async () => {
  ...
  bot.user.setActivity("Creating new, better Bot");
...
//Block KoolKidsKlub
  if(message.guild.id === "198693568423002112") {
    message.author.send("No point being here, leaving server.");
    message.guild.leave();
    console.log(`left KoolKidsKlub - User: ${message.author.tag}`);
  };
